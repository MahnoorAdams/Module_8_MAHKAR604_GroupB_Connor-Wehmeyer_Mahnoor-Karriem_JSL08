...
const branchA = new BankBranch({ name: "Main Branch", location: "123 Main St", manager: "Alice" });
const branchB = new BankBranch({ name: "Secondary Branch", location: "456 Second St", manager: "Bob" });

// Use the `getBranchInfo` method to retrieve branch information from the instances.
console.log(branchA.getBranchInfo()); // Output: { name: "Main Branch", location: "123 Main St", manager: "Alice" }
console.log(branchB.getBranchInfo()); // Output: { name: "Main Branch", location: "123 Main St", manager: "Alice" }
